...
export default function BlogHead(props){
  ...
  />
    <Grid container direction='column' justify='center' style={{width:'50%',marginLeft:'15vh'}}>
      <img src={CodeNCollab}  style={{ height:'10vh' ,width:'60vh' }} alt='CodeNCollab' />
      <Typography style={{color:'#fff',
      marginTop:'5vh',width:'60vh'}}> Official Page for
      Community Interaction and Announcements
      </Typography>
    </Grid>
